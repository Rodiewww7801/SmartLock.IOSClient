...
enum FaceLockAPIPaths {
    ...
    static let getDoorLockSecretInfo = "/api/DoorLock/{doorLockId}/GetDoorLockSecretInfo"
    ...
    static let updateSecretInfoLock = "/api/DoorLock/{doorLockId}/UpdateSecretInfoDoorLock"
