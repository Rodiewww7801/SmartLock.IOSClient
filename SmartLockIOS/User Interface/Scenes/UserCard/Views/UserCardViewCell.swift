...
class UserCardViewCell: UITableViewCell {
    ...
    private var predictionDistanceTitle: UILabel!
    private var predicationDistanceText: UILabel!
    ...
    func updateData(_ model: UserCardModel) {
        ...
        predicationDistanceText.text = String(model.predictionDistance)
    ...
    private func configureLabels() {
        ...
        predictionDistanceTitle = UILabel(frame: .zero)
        predictionDistanceTitle.text = "Prediction distance"
        predictionDistanceTitle.font = UIFont.preferredFont(forTextStyle: .body)
        predictionDistanceTitle.numberOfLines = 0
        predictionDistanceTitle.textColor = .gray
        predictionDistanceTitle.translatesAutoresizingMaskIntoConstraints = false
        self.addSubview(predictionDistanceTitle)
        ...
        predicationDistanceText = UILabel(frame: .zero)
        predicationDistanceText.font = UIFont.preferredFont(forTextStyle: .body)
        predicationDistanceText.numberOfLines = 0
        predicationDistanceText.textColor = .black
        predicationDistanceText.translatesAutoresizingMaskIntoConstraints = false
        self.addSubview(predicationDistanceText)
        ...
        predictionDistanceTitle.topAnchor.constraint(equalTo: roleLabelText.bottomAnchor, constant: 10).isActive = true
        predictionDistanceTitle.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 20).isActive = true
        predictionDistanceTitle.widthAnchor.constraint(equalTo: self.widthAnchor, constant: -20).isActive = true

        predicationDistanceText.topAnchor.constraint(equalTo: predictionDistanceTitle.bottomAnchor, constant: 10).isActive = true
        predicationDistanceText.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 20).isActive = true
        predicationDistanceText.widthAnchor.constraint(equalTo: self.widthAnchor, constant: -20).isActive = true
        predicationDistanceText.bottomAnchor.constraint(equalTo: self.bottomAnchor, constant: -20).isActive = true
    }
}
